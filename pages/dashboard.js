...
function Dashboard() {
  ...
  return (
    <div>
      <Head>
        <title>StarDust Voting | Dashboard</title>
      </Head>
      <Sidebar />

      <div className="lg:ml-80 ml-16 mr-2 mt-5 p-4 rounded bg-indigo-200">
        {pageLoading && (
        ...
        <div className="justify-center flex">
              <Link href="https://github.com/harikrsr">
                <a className="text-center text-primary underline font-thin">
                 Made By Hari Powered By Vercel & Netlify
                </a>
              </Link>
        </div>
     </div>
